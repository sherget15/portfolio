    ...
    <div className="App">
      ...
      <header>
        ...
        <div className='left-header'>
          ...
          <a href="https://drive.google.com/file/d/11f9mrALraOTgrJS5oUfFpSFNxS91NY8F/view?usp=sharing" download alt=' ' rel='noopener noreferrer' target="_blank">Resume</a>
        </div>
      ...
      <section className='projects' id='projects-section'>
        <div className='projects-div'>
          ...
          <a className='p4-link' href="https://sherget15.github.io/space_invader/"><img className='p4-img' src="https://i.imgur.com/usoQeo4.jpg" alt='' /></a>
        </div>
      </section>
