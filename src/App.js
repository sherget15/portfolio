    ...
    <div className="App">
      ...
      <section className='projects' id='projects-section'>
        <div className='projects-div'>
          ...
          <a className='p4-link' href='file:///Users/stephenherget/Documents/Professional/Projects/space_adventure/index.html'><img className='p4-img' src='https://i.imgur.com/w1J5exG.png' alt='' ></img></a>
        </div>
      </section>
